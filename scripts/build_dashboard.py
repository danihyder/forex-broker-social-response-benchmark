...
<div class="wrap">
  ...
  <div class="grid">
    ...
    <div class="card"><h3>Reply type</h3><p class="cap">Distribution of replies across three types: a substantive public answer, a redirect to a private channel, or a deferral to a regulator or ombudsman.</p><div id="cC"></div></div>
    ...
    <div class="card full"><h3>Complaint topics</h3><p class="cap">Share of each broker's complaints (1-2★ under the current filters) mentioning each topic. A review may carry more than one topic.</p><div id="cD"></div></div>
    ...
    <div class="card"><h3>Review length by rating</h3><p class="cap">Average review length in words by star band, across all reviews.</p><div id="cH"></div></div>
